...
@section('title', 'Pendaftaran Rapor dan Prestasi SMP')
    ...
    <div class="p-4">
        <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1 overflow-hidden">
                ...
                <p class="text-muted text-truncate mb-0">Sekolah asal, jurusan, nilai raport dan ijazah</p>
            </div>
...
<div id="school-data" class="collapse">
    <div class="p-4 border-top">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="mb-3 mb-4">
                    <label class="form-label" for="billing-address">Prestasi</label>
                    <div class="input-group">
                        <span class="input-group-text">Upload</span>
                        <div class="form-file">
